export default defineContentScript({
  ...
  main() {
    const aiIconHtml = `<div id="ai-icon" class="absolute z-9999 cursor-pointer hidden">
    ...
    const dialogHtml = `
      <div id="ai-dialog" class="hidden fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-96 h-30 bg-gray-100 border border-gray-400 rounded-2xl p-6 text-gray-400 shadow-lg z-10000">
        
        <input id="ai-input" type="text" placeholder="Your prompt" class="w-full border border-gray-400 text-gray-400 rounded-2xl p-2 mb-2">
        <div class="float-right">
          <button class="border-2 border-gray-600 text-lg font-medium py-2 px-3 rounded-2xl hidden" id="insert-btn">Insert</button>
          <button class="bg-blue-600 text-white text-lg font-medium py-2 px-3 rounded-2xl" id="generate-btn">Generate</button>
        </div>
        <p id="ai-response" class="mt-2"></p>
      </div>
    `;
